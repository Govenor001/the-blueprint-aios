...
That's it. Claude Code reads its own instructions, verifies the kit, learns the frameworks, and runs your Day-1 onboarding. No config files to edit, no keys to paste yet — wiring comes on Day 2.
...
---
*The rest of the build — wiring live data, the five wings, going 24/7, phone access — is the 7-day challenge. See `curriculum/CURRICULUM.md`.*
